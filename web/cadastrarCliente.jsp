                  ...
                  <div class="bg-background">
                    <form action="gerenciarCliente" method="POST">
                        ...
                        <input type="hidden" class="form-control" name="idCliente"
                               id="idMenu" value="${cliente.idCliente}"/>
                            <div class="row">
                        ...
                        <div class="d-grid gap-2 d-md-flex justify-content-md-center">
                            ...
                            <a href="listarCliente.jsp" class="btn btn-secondary btn-xs" role="button" >LISTAR CLIENTES&nbsp;<i class="fas fa-arrow-circle-left"></i></a>
                        </div>
                    </form>
                </div>
